...
pub struct Options {
    ...
    #[structopt(short = "g", long = "generations", default_value = "1000")]
    ...
    #[structopt(long = "parent-selection", possible_values = &ParentSelection::variants(), case_insensitive = true, default_value = "TournamentSelection")]
    pub parent_selection: ParentSelection,

    /// Survivor selection stragegy
    #[structopt(long = "survivor-selection", possible_values = &SurvivorSelection::variants(), case_insensitive = true, default_value = "FitnessBased")]
    pub survivor_selection: SurvivorSelection,

    /// Population model
    #[structopt(long = "population-model", possible_values = &PopulationModel::variants(), case_insensitive = true, default_value = "Generational")]
